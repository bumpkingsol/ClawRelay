...
- project-delta (first activity in 4 days)

### Continued from last period
- project-gamma (same branch: feature/notifications, deep focus)

### Dropped since last period
- project-alpha (was active last period, no activity this period)

### Project neglect
- project-beta: 6 days since last activity
- project-delta: 0 days (active now)
- project-alpha: 1 day
...
```
- project-gamma: 2.5h (includes 1h in Zoom call)
```
...
```
## Focus Level
- 09:00-12:00: focused (1.5 switches/hr, primarily project-gamma)
- 12:00-13:00: scattered (9 switches/hr)
- 13:00-17:00: multitasking (5 switches/hr, project-gamma + project-alpha)
```
