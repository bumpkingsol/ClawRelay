...
```json
{
  "whatsapp_whitelist": {
    "mode": "whitelist",
    "contacts": [
      { "id": "+34612345678", "label": "a business partner" },
      { "id": "+46701234567", "label": "Magnus (Project Alpha)" },
      { "id": "group:120363012345678901@g.us", "label": "Project Gamma Team" }
    ]
  }
}
```
...
```json
{"chat_id":"34612345678@s.whatsapp.net","chat_label":"a business partner","sender":"Nil","sender_jid":"34612345678@s.whatsapp.net","text":"Let's push the demo to Friday","ts":"2026-03-30T14:32:00Z","type":"text"}
{"chat_id":"34612345678@s.whatsapp.net","chat_label":"a business partner","sender":"Jonas","sender_jid":"self","text":"Works for me","ts":"2026-03-30T14:33:00Z","type":"text"}
{"chat_id":"120363012345678901@g.us","chat_label":"Project Gamma Team","sender":"Magnus","sender_jid":"46701234567@s.whatsapp.net","text":"PR merged, deploying now","ts":"2026-03-30T15:41:00Z","type":"text"}
{"chat_id":"120363012345678901@g.us","chat_label":"Project Gamma Team","sender":"Magnus","sender_jid":"46701234567@s.whatsapp.net","text":"","ts":"2026-03-30T15:42:00Z","type":"image","caption":"Staging screenshot"}
```
...
```json
{
  ...
  "app": "Cursor",
  "whatsapp_messages": [
    { "chat_id": "34612345678@s.whatsapp.net", "chat_label": "a business partner", "sender": "Nil", "text": "Let's push the demo to Friday", "ts": "2026-03-30T14:32:00Z", "type": "text" },
    { "chat_id": "34612345678@s.whatsapp.net", "chat_label": "a business partner", "sender": "self", "text": "Works for me", "ts": "2026-03-30T14:33:00Z", "type": "text" },
    { "chat_id": "120363012345678901@g.us", "chat_label": "Project Gamma Team", "sender": "Magnus", "text": "PR merged", "ts": "2026-03-30T15:41:00Z", "type": "text" }
  ]
}
```
...
**a business partner** (+34612345678) — 12 messages, 09:14–16:33
- Nil: "Let's push the demo to Friday"
- Jonas: "Works for me"
- Nil: "Here's the updated deck" [link: docs.google.com/...]
- ... (10 more)

**Project Gamma Team** (group) — 8 messages, 15:30–15:55
