...
```json
{
  ...
  "time_allocation": [
    {"project": "project-gamma", "hours": 2.3, "percentage": 48},
    {"project": "project-alpha", "hours": 1.5, "percentage": 31},
    {"project": "project-beta", "hours": 1.0, "percentage": 21}
  ],
  "neglected": [
    {"project": "project-delta", "days": 5},
    {"project": "project-beta", "days": 1},
    {"project": "openclaw", "days": 0}
  ],
  "jc_activity": [
    {"project": "project-alpha", "description": "PR review", "status": "in-progress", "started_at": "2026-03-28T13:00:00Z"},
    {"project": "project-beta", "description": "tax residency research", "status": "done", "completed_at": "2026-03-28T11:30:00Z", "duration_minutes": 45}
  ],
  "handoffs": [
    {"id": 1, "project": "project-beta", "task": "tax research", "message": "", "priority": "normal", "status": "done", "created_at": "2026-03-28T10:00:00Z"},
    {"id": 2, "project": "project-alpha", "task": "PR review", "message": "", "priority": "high", "status": "in-progress", "created_at": "2026-03-28T12:00:00Z"}
  ]
}
```
...
Format: `project-gamma 2.3h | JC: project-alpha`
