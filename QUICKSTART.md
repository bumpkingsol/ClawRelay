...
```bash
bash /home/admin/clawd/openclaw-computer-vision/server/start.sh
```
...
If missing:
```bash
(crontab -l 2>/dev/null | grep -v "context-receiver"; echo "@reboot /home/admin/clawd/openclaw-computer-vision/server/start.sh") | crontab -
```
