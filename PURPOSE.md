...
4. **Inability to work on "everything else."** When Jonas is coding Project Gamma, JC should be working on Project Alpha outreach. When Jonas is preparing a Project Delta deck, JC should be fixing Project Gamma P0 bugs. But JC had no way to know what Jonas was working on, so he either duplicated Jonas's work or did nothing useful.
...
- **Complementary work.** Jonas works on Project Gamma → JC works on Project Alpha. No duplication, no gaps.
