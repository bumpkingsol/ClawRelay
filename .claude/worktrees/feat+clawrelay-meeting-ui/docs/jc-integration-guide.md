...
0 9 * * * cd /home/admin/clawd/ && python3 context-digest.py >> /var/log/context-digest.log 2>&1
0 15 * * * cd /home/admin/clawd/ && python3 context-digest.py >> /var/log/context-digest.log 2>&1
0 22 * * * cd /home/admin/clawd/ && python3 context-digest.py >> /var/log/context-digest.log 2>&1
```
